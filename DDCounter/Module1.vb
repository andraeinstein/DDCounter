...
Module Module1
    ...
    Public ip As String
    Public lagi As String = "no"
    Public transaksi As String = "pulsa"
    Public urutid As Integer
    Public idtrxpul As Integer
    Public restartatauexit As String
